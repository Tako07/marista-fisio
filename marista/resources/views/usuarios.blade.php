...
<div id="search" class="container" style="padding-top: 2%;">
  <div class="row justify-content-md-center">
    ...
    <div class="col-md-auto">
      <button id="btnNuevoUsuario" class="col-md-auto btn btn-lg" type="button" style="color: #fff;line-height: 50%;">Nuevo Usuario</button>
    </div>
  </div>
</div>
...
<!-- The Modal -->
<div id="modalNuevoUsuario" class="modalB">
  ...
  <div class="modalB-content">
    ...
    <div class="modalB-body">
      ...
      <form method="post" onsubmit="{{route('registrarUsuario')}}">
        {{ csrf_field() }}
        <div class="form-row">
...
<script>
  ...
  var btn = document.getElementById("btnNuevoUsuario");
